...
void ZH_License()  // 定義 模式7：中文開源許可 輸出函式
{
	printf("\n\033[38;5;43m「基北北桃1200都會通定期票計算程式」（使用 C 語言）\n");
	printf("這裡是繁體中文版的 「開源許可」\033[0m\n");
	printf("\n\033[38;5;45m譯者聲明\n");
	printf("\033[38;5;197m　　這是GNU通用公共授權合約的一份非官方中文翻譯，並非自由軟體基金會所發表，不適用於使用GNU通用公共授權合約發佈的軟體的法律聲明——只有GNU通用公共授權合約英文原版才具有法律效力。不過我們希望本翻譯能夠幫助中文讀者更好地理解GNU通用公共授權合約。 您可以僅根據http://www.gnu.org/licenses/translations.html中的條款發布此修改或未修改的翻譯。\033[0m\n\n");
	printf("\033[38;5;45mGNU 通用公共授權合約 第二版，1991年6月\n\n");
	printf("版權所有 (C) 1989, 1991 自由軟體基金會.\n51 Franklin Street, Fifth Floor, Boston, MA 02110-1301 USA\n\n");
	printf("任何人都可以複製和發布本授權合約的完整副本，但不得修改。\n\n");
	printf("引言\033[0m\n");
	...
	printf("\033[38;5;45m關於複製、分發和修改的術語和條件\033[0m\n\n");
	...
	printf("\033[38;5;45m不提供品質擔保\033[0m\n\n");
	...
	printf("\033[38;5;208m條款和條件結束\033[0m\a\n\n");
	system("pause");  // 暫停程式運行
}